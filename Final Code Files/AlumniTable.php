			    	...
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
						...
						<div class=row col-md-12 style="margin-top: 3%;">
							<div col-md-3   style=" margin-left: 25%;">
														<form action="getalumniInfo.php" method="post">
														<select  class="js-example-basic-single" name = "Year" id="year">
									...
									<div col-md-3 style=" margin-left: 4%;">
													<select class="js-example-basic-single" name = "Company" id="company" style="    background-color: #e04f4f;
												border: none;
												color: white;
												padding: 2%;">
									...
									<input type="submit" col-md-3 style=" margin-left: 3%;" class="button button2" value="Search"/>
							</div>
							<p name="disclaimer" style="margin-left: 74%;
    font-size: 11px;">*Click Search without filters to display all values</p>
				</form>
